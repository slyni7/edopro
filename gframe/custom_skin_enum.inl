...
DECLR(DUELFIELD_LINKED, CLR(255, 129, 176, 204))
DECLR(DUELFIELD_MUTUAL_LINKED, CLR(255, 128, 204, 128))
DECLR(DUELFIELD_ATTRIBUTE_FIRE, CLR(255, 255, 0, 0))
DECLR(DUELFIELD_ATTRIBUTE_EARTH, CLR(255, 255, 128, 0))
DECLR(DUELFIELD_ATTRIBUTE_LIGHT, CLR(255, 255, 255, 0))
DECLR(DUELFIELD_ATTRIBUTE_WIND, CLR(255, 0, 192, 0))
DECLR(DUELFIELD_ATTRIBUTE_WATER, CLR(255, 0, 128, 255))
DECLR(DUELFIELD_ATTRIBUTE_DARK, CLR(255, 128, 0, 255))
DECLR(DUELFIELD_ATTRIBUTE_DIVINE, CLR(255, 255, 255, 255))
DECLR(DUELFIELD_TYPE_SPELL, CLR(255, 0, 255, 128))
DECLR(DUELFIELD_TYPE_TRAP, CLR(255, 255, 0, 128))
DECLR(DUELFIELD_IMPINF, CLR(255, 128, 0, 64))
...
DECLR(DUELFIELD_ATTACK_ARROW, 0x8000ff00)
